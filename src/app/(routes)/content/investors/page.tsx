...
const account_required: AccountRequired = AccountRequired.Investor; //can also be typed as 'number' since it's a numbered enum.

const InvestorsPage = async () => { //We can use async-await because it's a server component.
    ...
    return (
        <div>
            <h1>Investor content</h1>
            <p>You should only be able to see this page if you're logged in.</p>
            <p>Additionally, this content can only be seen by investors.</p>
...
export default requireAuthCompositionPattern(InvestorsPage, account_required);